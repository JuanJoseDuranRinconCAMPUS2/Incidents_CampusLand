...
export const getUserV100 = async ( req,res)=>{
    try {
...
export const postUserV100 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putUserV100 = async (req,res)=>{
...
export const deleteUserV100 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let id = req.body.id
