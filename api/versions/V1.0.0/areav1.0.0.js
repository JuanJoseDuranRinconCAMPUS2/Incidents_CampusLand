...
export const getAreaV100 = async ( req,res)=>{
    try {
...
export const postAreaV100 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
        const id =  await increment("Area");
...
export const putAreaV100 = async (req,res)=>{
...
export const deleteAreaV100 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let id = req.body.id
